  ...
  return (
    <>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-4">
            <h2 className="text-2xl font-bold text-center mb-6">Waiting for other players...</h2>
            <div className="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-blue-500"></div>
            <p className="mt-6 text-lg text-gray-600">Your answer has been submitted. Please wait while others finish.</p>
        </div>
        )}
    </>
